...
public class RegisterEntities {
    ...
    public static final EntityType<AncientHornProjectile> ANCIENT_HORN_PROJECTILE = Registry.register(Registry.ENTITY_TYPE, WilderWild.id("ancient_horn_projectile"), FabricEntityTypeBuilder.<AncientHornProjectile>create(SpawnGroup.MISC, AncientHornProjectile::new).dimensions(EntityDimensions.fixed(0.6F, 0.6F)).trackRangeBlocks(64).trackedUpdateRate(2).build());
